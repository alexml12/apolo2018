...
<tbody>
 ...
 if(!empty($alumnos)){
 	foreach($alumnos as $alumno){
		...
		echo '<td>'
?>
		<a href="<?php echo base_url();?>index.php/alumnos/editar/<?php echo $alumno->id_alumno;?>/" class="btn btn-success">Editar</a>
		<!--<a href="<?php echo base_url();?>index.php/alumnos/password/<?php echo $alumno->id_alumno ?>" class="btn btn-default">Password</a>
		<a href="<?php echo base_url();?>index.php/alumnos/permisos/<?php echo $alumno->id_alumno;?>" class="btn btn-info">Permisos</a> -->
		<a href="<?php echo base_url();?>index.php/alumnos/eliminar/<?php echo $alumno->id_alumno ?>" class="btn btn-danger">Eliminar</a>
<?php		
		echo '</td>';
